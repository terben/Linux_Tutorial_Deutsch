...
\begin{tikzpicture}
  ...
  \begin{scope}[x={(image.south east)},y={(image.north west)}]
    ...
    (0.5, -0.6) {Befehlszelle; \\ \texttt{Shift+Enter} um auszuführen};
    ...
    -1.4) {Befehlszelle ausführen \\ auf mobilen Geräten};
    \draw[red, thick] (0.13, 0.54) rectangle (0.93, 0.96);
    \draw[blue, thick] (0.019, 0.08) rectangle (0.99, 0.46);
    \draw[black!30!green, thick] (0.16, 0.17) rectangle (0.19, 0.39);
    \draw[-latex, blue, thick] (befehl) to (0.5, 0.08);
    \draw[-latex, red, thick] (text) to (0.5, 0.96);
    \draw[-latex, black!30!green, thick] (befehl-mobil) to (0.18, 0.17);
  \end{scope}
\end{tikzpicture}
